...
## 直运电商/Dropshipping 的好处

![](http://ydlj.zoomquiet.top/ipic/2020-10-13-Benefits-of-Dropshipping-1024x1024.png)

**1: 易于启动.** 
您无需成为业务专家就可以开始. 实际上,您甚至不需要任何业务经验!如果您花一些时间来学习基础知识,则可以快速入门,并随着业务发展再继续学习其余内容.  
...
**3: 不需要大量资金.**
由于开展 直运电商/Dropshipping 所需资金很少,
因此您可以从最小的资金开始;
可以直接通过笔记本电脑建立整个企业,
而无需进行任何高端投资;
即便您的业务增长,
整体成本也会相当低 --- 尤其与传统业务费用相比时;
...
这是最大的好处之一;
您可以成为自己的老板并制定自己的规则;
这是迄今为此任何人都可以从事的最灵活职业之一;

只需要一台笔记本电脑就可以在家开展工作,
并可以在最方便的时间进行;
这对于想违章自己企业的企业家来说是理想的选择;
您不必迁就其它事,
相反,
您可以设定自己的步调.

直运电商/Dropshipping 的灵活还在于,
为您提供了很大的空间来作出最适合疤的决定;
您可以随时轻松选出新产品,
并可以随时调整策略;
如果你要去度假,
可以在外出时自动执行所有操作;
...
## 直运电商/Dropshipping 的缺点

![](http://ydlj.zoomquiet.top/ipic/2020-10-13-Disadvantages-of-Dropshipping-1024x1024.png)

**1: 利润微薄.**

直运电商/Dropshipping 缺点之一就是您必须将期望利润调低;
这并不是说不能盈利,
但是应该意识到某些细分市场的产品利润空间可能很小;

当你在 "超竞利基"/niche 领域进行 直运电商/Dropshipping 时,
这个问题尤其重要;
当您争取客户注意力时,
就难以获得想要的利润;
...
只有选择了正确的 利基市场/niche,
才会获得更大的利润;
在竞争较低的细分市场中, 您将获得更高的利润率,
但总是会在某些时候销售开始趋于平稳;
这也是为什么 直运电商/Dropshipping 依赖大量销售才能盈利的原因;


**2: 订单处理艰难.**

直运电商/Dropshipping 看起来很简单:
客户下单->您处理->供应商完成;
...
**3: 控制权不多.**
直运电商/Dropshipping 的缺点之一是您对代销过程某些方面没有太多控制权,
例如库存/订单履行/运输/...
您必须依靠供应商来正确执行并无缝完成所有工作;
...
虽然供应商问题会导致`客户维护`问题,
但是可以通过其它方法来缓解;
并通过正确的损伤控制将客户流失率降至最低;



**4: 客户服务挑战.**

在 直运电商/Dropshipping 场景中,
客户服务将更具有挑战性;
这是订单出错或供应商失误时引发的另一个问题;
毕竟您只拥有店面并没更多控制权,
所以, 可能很难整理订单并处理客户支持;
